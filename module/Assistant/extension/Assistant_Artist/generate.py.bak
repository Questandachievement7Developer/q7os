...
H = '[OrionArtisticEngine_TechDemo]'
# default arguments
CONTENT_WEIGHT = 5e1
#CONTENT_WEIGHT = randint(5, 10)
CONTENT_WEIGHT_BLEND = 1
STYLE_WEIGHT = 5e2
#STYLE_WEIGHT = randint(300, 700)
TV_WEIGHT = 1e2
STYLE_LAYER_WEIGHT_EXP = 1
#LEARNING_RATE = 1e1
LEARNING_RATE = 1.213278620111204
BETA1 = 0.9
BETA2 = 0.999
EPSILON = 1e-08
STYLE_SCALE = 1
ITERATIONS = randint(1024, 4096)
#ITERATIONS = 1000
VGG_PATH = 'skills.bin'
POOLING = 'max'
OUTPUT = 'results/output' + str(randint(5, 202248)) + '.jpg'
