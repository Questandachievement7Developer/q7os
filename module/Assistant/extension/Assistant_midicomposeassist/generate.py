...
num_timesteps  = randint(15, 27)  #15 #This is the number of timesteps that we will create at a time
n_visible      = 2*note_range*num_timesteps #This is the size of the visible layer.
n_hidden       = randint(3, 100)#(100, 10000) #50 #This is the size of the hidden layer # adjusts Speed (Optimization Key)
print(num_timesteps)
print(n_hidden)
...
num_epochs = randint(20, 2000) #The number of training epochs that we are going to run. For each epoch we go through the entire data set.
batch_size = randint(100, 1280) #The number of training examples that we are going to send through the RBM at a time.# adjusts Memory Usage
lr         = tf.constant(0.012, tf.float32) #The learning rate of our model
