...
clip = VideoFileClip("/Assistant/extension/Assistant_autoeditor/input.mp4")
...
peaks_times = peaks_times[peaks_vols>np.percentile(peaks_vols,45)]
...
final = concatenate([clip.subclip(max(t-5,0),min(t+15, clip.duration))
                     for t in final_times])
final.to_videofile('/Assistant/extension/Assistant_autoeditor/output.mp4') # low quality is the default
